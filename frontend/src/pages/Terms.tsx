      ...
      <div className="container px-4">
        ...
        >
          ...
          <div className="bg-card p-8 md:p-12 rounded-3xl border-2 space-y-8 text-muted-foreground leading-relaxed">
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">{t('about.usage_terms')}</h2>
              <p>{t('about.terms_content')}</p>
            </section>
            
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">{t('about.disclaimer')}</h2>
              <p>{t('about.disclaimer_desc')}</p>
            </section>
          </div>
        </motion.div>
      </div>
